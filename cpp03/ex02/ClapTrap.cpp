...
/*   Updated: 2023/01/09 16:07:23 by aparedes         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ClapTrap.hpp"

ClapTrap::ClapTrap(): _name("default"), _hitPoints(100), _energyPoints(50) , _dps(20){
	std::cout << "ClapTrap created" << std::endl;
}

ClapTrap::ClapTrap(std::string const &name): _name(name), _hitPoints(100), _energyPoints(50) , _dps(20){
